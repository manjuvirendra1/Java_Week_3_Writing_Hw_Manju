...
/**
 *6.Write a java program input seller id, sellers name, sales amount, and basic salary
 ...
 *
 */
public class Pr_7_SalesCommission {
    public static void main(String[] args) {
        ...
        Pr_7_SalesCommission salesCommission = new Pr_7_SalesCommission();
