...
/**
 *7.Input any alphabet from “A to “F” and print their city name accordingly (use if else) if
 * any other alphabet should be invalid entry
 */

public class Pr_8_PrintCityName {
    public static void main(String[] args) {
        ...
        //Object creation
        Pr_8_PrintCityName cityName = new Pr_8_PrintCityName();
